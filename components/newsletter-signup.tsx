      ...
      <div className={`bg-white/5 border border-white/10 rounded-lg p-4 backdrop-blur-sm ${className}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          {showNameFields && (
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="px-3 py-2 bg-white/10 border border-white/20 rounded text-white placeholder-white/40 focus:outline-none focus:border-purple-400 text-sm"
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded text-white placeholder-white/40 focus:outline-none focus:border-purple-400 text-sm"
            disabled={status === "loading"}
            required
          />
          <Button
      ...
      <div className="max-w-md mx-auto">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            ...
            <Button
              type="submit"
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 whitespace-nowrap disabled:opacity-50"
              disabled={status === "loading"}
            >
              {status === "loading" ? (
                <>
